...
def test_flatmean_const_3chan():
    ...
    pcot.setup()
    doc = Document()
    img = genrgb(50, 50, 0, 0.3, 0, inpidx=0)  # dark green
...
def test_mean_2halves():
    ...
    pcot.setup()
    doc = Document()
    img = gen_two_halves(50, 50, (0.1,), (0.0,), (0.2,), (0.0,), inpidx=0)
...
def test_mean_2halves_diffuncs():
    ...
    img = gen_two_halves(50, 50, (0.1,), (0.01,), (0.2,), (0.02,), inpidx=0)
...
def test_mean_2halves_diffuncs_bad():
    ...
    img = gen_two_halves(2, 2, (0.1,), (0.01,), (0.2,), (0.02,), inpidx=0)
...
def test_sd_const_grey():
    ...
    pcot.setup()
    doc = Document()
    img = genrgb(50, 50, 0.1, 0.1, 0.1, inpidx=0)  # dark green
...
def test_sd_const_nongrey():
    ...
    pcot.setup()
    doc = Document()
    img = genrgb(2, 2, 0, 1, 0, inpidx=0)  # dark green
...
def test_sd_2halves():
    ...
    pcot.setup()
    doc = Document()
    img = gen_two_halves(2, 2, (1,), (0.0,), (2,), (0.0,), inpidx=0)
...
def test_sd_2halves_diffuncs():
    ...
    pcot.setup()
    doc = Document()
    img = gen_two_halves(2, 2, (1,), (4.0,), (2,), (5.0,), inpidx=0)
...
def test_sum_unc():
    pcot.setup()
    doc = Document()
    img = gen_two_halves(2, 2, (1,), (0.1,), (2,), (0.2,), inpidx=0)
