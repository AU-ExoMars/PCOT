...
class ROI(SourcesObtainable, Annotation):
    ...
    def __init__(self, bbrect: Rect = None, maskimg: np.array = None, sourceROI=None, isTemp=False):
        ...
        # only applies to 'plain' ROIs generated by a negation operation - means the ROI is inverted
        self.inverted = False
    ...
    def roiUnion(rois):
        ...
        if len(bbs) > 0:
            ...
            return ROI(bb, mask, isTemp=True)  # should not be saved
        else:
            # return a null ROI
            return None
    ...
    def roiIntersection(rois):
        ...
        for r in rois:
            ...
            mask &= workMask
        return ROI(bb, mask, isTemp=True)
    ...
    def clipToImage(self, img: ndarray):
        ...
        if bb is not None:
            ...
            # construct the ROI.
            return ROI(intersect, mask, isTemp=True)  # should never be saved
        else:
            return None
    ...
    def __neg__(self):
        # effectively flattens the ROI - no matter what the type - into a "plain" mask-based ROI.
        r = self.roiUnion([self])
        r.inverted = True  # and set the inversion flag
        return r
