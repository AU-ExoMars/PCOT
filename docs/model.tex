...
and functions which manipulate data are required to handle sources correctly, and this can be difficult.
\end{itemize}
...
\begin{todoblock}
Much of the information here about Channel Sources is out of date and replaced by
the SourcesObtainable interface. This needs fixing.
\end{todoblock}
